...
//    System.out.println ("Visita "+u+" Descoberta:"+this.d[u]+" cinza");
        if (!this.grafo.listaAdjVazia(u)) {
            ...
            while (a != null) {
                ...
                else if(cor[v] == cinza){ //um grafo é considerado ciclico se uma aresta de retorno (representada pela cor cinza) 
                    this.ciclico = true; //é encontrada em sua busca em profundidade
                }
